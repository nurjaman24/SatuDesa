...
class desa extends CI_Controller {
    ...
    // Create =======================================================================================================
        // Start Rukun Warga (Done)
            // Menggunakan Formulir Di Modal 
            // Rukun Warga (Done)
    ...
    // Read =========================================================================================================
        ...
        // Akun Warga
            public function akunwarga(){
                ...
                $this->load->view('Desa/Page/Akunwarga/data', $data);
                $this->load->view('Desa/Layout/footer');
            }
        // Jenis Dokumen
    ...
    // Update =======================================================================================================
        // Rukun Warga (Done)
            function edit_rw($id_rukun_warga){
                ...
                // edit_data_join($nm_tabel, $nm_tabel_join, $on, $kondisi)
        ...
        // Akun Warga
            function edit_akunwarga($id_warga){
                ...
                $this->load->view('Desa/Page/Akunwarga/edit',$data);
                $this->load->view('Desa/Layout/footer');
            }
