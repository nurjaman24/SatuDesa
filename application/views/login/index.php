    ...
    <div class="error-page-int" style="margin-top:-10%;">
      ...
      <div class="text-center m-b-md custom-login">
        <div class="row">
          ...
          <img src="<?= base_url('asset/img/logo/ImageTextSatuDesa.png')?>" alt="" class="" width="50%">
        </div>
      </div>
      <hr>
      <div class="tagline">
          ...
          <div class="panel-body">
            <form method="post" action="<?= base_url('Login/auth'); ?>">
              <div class="form-group">
                ...
                <input type="text" placeholder="Contoh : adminsadesa" title="Masukan Nama Pengguna" required="true"
                  value="" name="username" id="" class="form-control" autocomplete="off" autofocus>
              </div>
              <div class="form-group">
                ...
                <input type="password" title="Please enter your password" placeholder="******" required="" value=""
                  name="password" id="showPassword" class="form-control" autocomplete="off"><br>
