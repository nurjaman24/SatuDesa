        ...
        <div class="sidebar-header">
          <a href="#">
            <div class="row">
              ...
              <!-- <img class="main-logo" src="<?= base_url('asset/img/logo/ImageTextSatuDesasm.png') ?>" width="30%" /> -->
            </div>
          </a>
          <strong><a href="#"><img src="<?= base_url('asset/img/logo/IconBaruSatuDesa.png') ?>" alt=""
                width="45%" /></a></strong>
        </div>
        <hr>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
          <nav class="sidebar-nav left-sidebar-menu-pro">
            <ul class="metismenu" id="menu1">
              ...
              <li>
                <a title="Data Admin Desa" href="<?= base_url('Login/logout') ?>" aria-expanded="false"
