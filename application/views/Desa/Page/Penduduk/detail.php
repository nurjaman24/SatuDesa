                                            ...
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr><td>Alamat Lengkap</td><td><?= $tpen->alamat." RT/RW ".$tpen->rukun_tetangga."/".$tpen->no_rukun_warga."<br>".ucwords(strtolower($tpen->nama_desa))." ".$tpen->kecamatan." ".$tpen->kabupaten?></td></tr>
